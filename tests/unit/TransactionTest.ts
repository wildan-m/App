...
describe('Transaction', () => {
    ...
    describe('changeTransactionsReport', () => {
        ...
        it('should generate CUSTOM_UNIT_OUT_OF_POLICY violation when the rate is disabled and there is no valid rate to move to', async () => {
            const policyID = '103';
            const disabledRateID = 'disabled_workspace_rate';
            const transaction = generateTransaction({
                reportID: FAKE_OLD_REPORT_ID,
                amount: -500,
                currency: 'USD',
