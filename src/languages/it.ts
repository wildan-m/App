...
${amount} per ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        collectEmployeeBankDetails: 'Raccogli i dati bancari dei dipendenti',
        collectEmployeeBankDetailsDescription: 'Raccogli i dati bancari dei dipendenti così puoi rimborsarli in più di un paese.',
        businessBankAccountCountries: 'Paesi dei conti bancari aziendali',
        reimbursementCountriesErrorMessage: 'Aggiornamento dei tuoi paesi di rimborso non riuscito. Riprova.',
    },
