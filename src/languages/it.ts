...
${amount} per ${merchant} - ${date}`,
        ...
        visitAnATM: 'Cambia il tuo PIN a qualsiasi bancomat',
        visitAnATMDescription: 'Questo è obbligatorio nella tua regione. <concierge-link>Contatta Concierge</concierge-link> se hai domande.',
