...
${amount} per ${merchant} - ${date}`,
    ...
    addPersonalBankAccount: {
        ...
        internationalBankAccountDetailsStepHeader: 'Quali sono i dati del tuo conto bancario internazionale?',
        internationalBankAccountDetailsStepSubHeader: 'Ci servono questi dati così l’amministratore del tuo spazio di lavoro può inviare pagamenti al tuo conto bancario oltre confine.',
        iban: 'IBAN',
        swiftCode: 'Codice SWIFT/BIC',
        error: {invalidSwiftCodeOrIban: 'Inserisci un codice SWIFT/IBAN valido'},
    },
