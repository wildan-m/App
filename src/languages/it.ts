...
_Per istruzioni più dettagliate, [visita il nostro sito di assistenza](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        businessCentral: {
            importDescription: 'Scegli quali configurazioni di codifica importare da Business Central.',
            accountsDescription: 'Il tuo piano dei conti di Business Central verrà importato come categorie.',
            enableNewAccountsTitle: 'Abilita i conti appena importati',
            enableNewAccountsDescription: 'I nuovi conti Business Central saranno disponibili come categorie.',
            dimensionsImport: 'Importa le dimensioni di Business Central come tag',
            importedAsTags: 'Importata come tag',
            notImported: 'Non importata',
            taxRatesDescription: 'Importa le aliquote IVA UE da Business Central.',
        },
        dualEntry: {
