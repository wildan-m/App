...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverrides: 'Override delle beta',
            betaOverridesDescription: 'Un interruttore prevale sempre sullo stato del backend per quella beta. Le beta non toccate seguono il tuo account.',
            resetAllBetaOverrides: 'Reimposta tutti gli override',
            overridden: 'sovrascritta',
