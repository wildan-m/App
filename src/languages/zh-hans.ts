...
${amount}，商户：${merchant} - 日期：${date}`,
    ...
    addPersonalBankAccount: {
        ...
        internationalBankAccountDetailsStepHeader: '您的国际银行账户信息是什么？',
        internationalBankAccountDetailsStepSubHeader: '我们需要这些信息，以便你的工作区管理员可以向你在海外的银行账户付款。',
        iban: 'IBAN',
        swiftCode: 'SWIFT/BIC 代码',
        error: {invalidSwiftCodeOrIban: '请输入有效的 Swift 代码/IBAN'},
    },
