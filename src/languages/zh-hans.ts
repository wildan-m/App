...
${amount}，商户：${merchant} - 日期：${date}`,
    ...
    statusPage: {
        ...
        chooseDelegate: '选择代理人',
        vacationDelegateClearAfter: '清除时间（推荐）',
        vacationDelegateWillClearOn: (date: string) => `休假代理人将于以下日期清除：${date}`,
        vacationDelegateUntil: (date: string) => `截至 ${date}`,
