...
${amount}，商户：${merchant} - 日期：${date}`,
    ...
    workflowsPage: {
        ...
        finalApprover: '最终审批人',
        manager: '经理',
        collectEmployeeBankDetails: '收集员工银行信息',
        collectEmployeeBankDetailsDescription: '从员工处收集银行账户信息，以便您可以在多个国家向他们报销。',
        businessBankAccountCountries: '可用的企业银行账户国家',
        reimbursementCountriesErrorMessage: '更新报销国家失败。请重试。',
    },
