...
_如需更详细的说明，请[访问我们的帮助网站](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})。_`,
        ...
        businessCentral: {
            importDescription: '选择要从 Business Central 导入的编码配置。',
            accountsDescription: '您的 Business Central 会计科目表将作为类别导入。',
            enableNewAccountsTitle: '启用新导入的账户',
            enableNewAccountsDescription: '新的 Business Central 账户将作为类别提供。',
            dimensionsImport: '将 Business Central 维度作为标签导入',
            importedAsTags: '已作为标签导入',
            notImported: '未导入',
            taxRatesDescription: '从 Business Central 导入欧盟增值税税率。',
        },
        dualEntry: {
