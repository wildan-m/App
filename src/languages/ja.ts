...
${date} の ${merchant} への ${amount}`,
    ...
    workflowsPage: {
        ...
        finalApprover: '最終承認者',
        manager: 'マネージャー',
        collectEmployeeBankDetails: '従業員の銀行口座情報を収集します',
        collectEmployeeBankDetailsDescription: '従業員の銀行口座情報を収集して、複数の国で払い戻しができるようにします。',
        businessBankAccountCountries: 'ビジネス銀行口座の国',
        reimbursementCountriesErrorMessage: '精算対象国の更新に失敗しました。もう一度お試しください。',
    },
