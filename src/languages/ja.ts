...
_詳しい手順については、[ヘルプサイトをご覧ください](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_。`,
        ...
        businessCentral: {
            importDescription: 'Business Central からインポートするコーディング設定を選択します。',
            accountsDescription: 'Business Central の勘定科目表はカテゴリとしてインポートされます。',
            enableNewAccountsTitle: '新しくインポートした口座を有効にする',
            enableNewAccountsDescription: '新しい Business Central アカウントは、カテゴリとして利用できるようになります。',
            dimensionsImport: 'Business Central のディメンションをタグとしてインポート',
            importedAsTags: 'タグとしてインポート済み',
            notImported: 'インポートされていません',
            taxRatesDescription: 'Business Central から EU の VAT 税率をインポートします。',
        },
        dualEntry: {
