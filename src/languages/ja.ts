...
会社のキャッシュフローを守るために、支出ルールをさらに追加しましょう。`,
    ...
    productMarketingWindow: {
        august2026: {
            cta: 'お試しください',
            admin: {heading: 'ベンダーマッピングの強化', body: '主要な会計ソフトへのマッピングを簡単にするために、取引先とカスタムルールを作成できます。'},
            member: {heading: '事前作成されたエージェント', body: 'あらかじめ用意されたエージェントやカスタムエージェントを利用して、経費を自動でコード化・分割・提出します。'},
        },
    },
