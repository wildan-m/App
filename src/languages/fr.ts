...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverrides: 'Overrides de bêtas',
            betaOverridesDescription: 'Un interrupteur prime toujours sur l’état du backend pour cette bêta. Les bêtas non modifiées suivent votre compte.',
            resetAllBetaOverrides: 'Réinitialiser tous les overrides',
