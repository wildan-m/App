...
${amount} pour ${merchant} - ${date}`,
        ...
        visitAnATM: 'Modifiez votre code PIN à n’importe quel distributeur automatique de billets',
        visitAnATMDescription: 'Ceci est obligatoire dans votre région. <concierge-link>Contacter Concierge</concierge-link> si vous avez des questions.',
