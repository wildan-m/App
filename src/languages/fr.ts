...
_Pour des instructions plus détaillées, [visitez notre site d’aide](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        businessCentral: {
            importDescription: 'Choisissez les configurations de codage à importer depuis Business Central.',
            accountsDescription: 'Votre plan comptable Business Central sera importé en tant que catégories.',
            enableNewAccountsTitle: 'Activer les nouveaux comptes importés',
            enableNewAccountsDescription: 'Les nouveaux comptes Business Central seront disponibles en tant que catégories.',
            dimensionsImport: 'Importer les dimensions Business Central en tant que tags',
            importedAsTags: 'Importée en tant que tags',
            notImported: 'Non importée',
            taxRatesDescription: 'Importer les taux de TVA européenne depuis Business Central.',
        },
        dualEntry: {
