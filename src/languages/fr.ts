...
${amount} pour ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        manager: 'Manager',
        collectEmployeeBankDetails: 'Collecter les coordonnées bancaires des employés',
        collectEmployeeBankDetailsDescription: 'Collectez les coordonnées bancaires des employés afin de pouvoir les rembourser dans plusieurs pays.',
        businessBankAccountCountries: 'Pays des comptes bancaires professionnels',
        reimbursementCountriesErrorMessage: 'La mise à jour de vos pays de remboursement a échoué. Veuillez réessayer.',
    },
