...
${amount} für ${merchant} – ${date}`,
    ...
    addPersonalBankAccount: {
        ...
        internationalBankAccountDetailsStepHeader: 'Wie lauten Ihre internationalen Bankkontodaten?',
        internationalBankAccountDetailsStepSubHeader: 'Wir benötigen diese Angaben, damit Ihre Workspace-Admin-Zentrale grenzüberschreitende Zahlungen auf Ihr Bankkonto senden kann.',
        iban: 'IBAN',
        swiftCode: 'SWIFT-/BIC-Code',
        error: {invalidSwiftCodeOrIban: 'Bitte geben Sie einen gültigen Swift-Code/IBAN ein'},
    },
