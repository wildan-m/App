...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverridesDescription: 'Ein Schalter hat für dieses Beta immer Vorrang vor dem Backend-Status. Nicht angetastete Betas folgen deinem Konto.',
            resetAllBetaOverrides: 'Alle Overrides zurücksetzen',
