...
${amount} für ${merchant} – ${date}`,
    ...
    statusPage: {
        ...
        chooseDelegate: 'Vertretung auswählen',
        vacationDelegateClearAfter: 'Löschen nach (empfohlen)',
        vacationDelegateWillClearOn: (date: string) => `Die Urlaubsvertretung wird gelöscht am ${date}`,
        vacationDelegateUntil: (date: string) => `Bis ${date}`,
