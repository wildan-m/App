...
${amount} für ${merchant} – ${date}`,
    ...
    workflowsPage: {
        ...
        manager: 'Manager',
        collectEmployeeBankDetails: 'Bankdaten von Mitarbeitenden erfassen',
        collectEmployeeBankDetailsDescription: 'Erfassen Sie die Bankdaten von Mitarbeitenden, damit Sie sie in mehr als einem Land erstatten können.',
        businessBankAccountCountries: 'Länder für Geschäftskonten',
        reimbursementCountriesErrorMessage: 'Die Aktualisierung Ihrer Erstattungsländer ist fehlgeschlagen. Bitte versuchen Sie es erneut.',
    },
