...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    concierge: {
        ...
        feedback: {prompt: 'War diese Antwort hilfreich?', thanks: 'Danke für Ihr Feedback!', useful: 'Diese Antwort war hilfreich', notUseful: 'Diese Antwort war nicht hilfreich'},
    },
    supportalNoAccess: {
