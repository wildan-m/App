...
${amount} für ${merchant} – ${date}`,
        ...
        visitAnATM: 'Ändern Sie Ihre PIN an jedem Geldautomaten',
        visitAnATMDescription: 'Dies ist in Ihrer Region erforderlich. <concierge-link>Kontaktieren Sie Concierge</concierge-link> falls Sie Fragen haben.',
