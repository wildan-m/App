...
_Für ausführlichere Anweisungen [besuchen Sie unsere Hilfeseite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        businessCentral: {
            importDescription: 'Wählen Sie aus, welche Kodierungskonfigurationen aus Business Central importiert werden sollen.',
            accountsDescription: 'Ihr Business Central-Kontenplan wird als Kategorien importiert.',
            enableNewAccountsTitle: 'Neu importierte Konten aktivieren',
            enableNewAccountsDescription: 'Neue Business Central-Konten werden als Kategorien verfügbar sein.',
            dimensionsImport: 'Business Central-Dimensionen als Tags importieren',
            importedAsTags: 'Als Tags importiert',
            notImported: 'Nicht importiert',
            taxRatesDescription: 'EU-Mehrwertsteuersätze aus Business Central importieren.',
        },
        dualEntry: {
