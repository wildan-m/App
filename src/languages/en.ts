...
const translations = {
    ...
    workspace: {
        ...
        businessCentral: {
            importDescription: 'Choose which coding configurations to import from Business Central.',
            accountsDescription: 'Your Business Central chart of accounts will import as categories.',
            enableNewAccountsTitle: 'Enable newly imported accounts',
            enableNewAccountsDescription: 'New Business Central accounts will be available as categories.',
            dimensionsImport: 'Import Business Central dimensions as tags',
            importedAsTags: 'Imported as tags',
            notImported: 'Not imported',
            taxRatesDescription: 'Import EU VAT tax rates from Business Central.',
        },
        dualEntry: {
