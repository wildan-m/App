...
const translations = {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverridesDescription: 'A switch always wins over the backend state for that beta. Untouched betas follow your account.',
            resetAllBetaOverrides: 'Reset all overrides',
