    ...
    workspace: {
        ...
        rules: {
            individualExpenseRules: {
                ...
                publicReceiptVisibilityDisabledHint: 'Receipts are only viewable by Expensify members with access to the report containing the receipt.',
                publicReceiptVisibilityEnabledHint: 'Receipts are viewable by anyone with the URL. Access to the report with the receipt is not required.',
