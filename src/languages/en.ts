...
const translations = {
    ...
    composer: {
        ...
        taskTitleExceededMaxLength: ({ formattedLength, formattedMaxLength }: FormattedMaxLengthParams) => `The maximum task title length limit reached (${formattedLength}/${formattedMaxLength})`,
    },
    baseUpdateAppModal: {
