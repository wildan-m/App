...
${amount} voor ${merchant} - ${date}`,
    ...
    addPersonalBankAccount: {
        ...
        internationalBankAccountDetailsStepHeader: 'Wat zijn je internationale bankgegevens?',
        internationalBankAccountDetailsStepSubHeader: 'We hebben deze gegevens nodig zodat de beheerder van je werkruimte betalingen over de grens naar je bank kan sturen.',
        iban: 'IBAN',
        swiftCode: 'SWIFT-/BIC-code',
        error: {invalidSwiftCodeOrIban: 'Voer een geldige Swift-code/IBAN in'},
    },
