...
${amount} voor ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        manager: 'Manager',
        collectEmployeeBankDetails: 'Bankgegevens van medewerkers verzamelen',
        collectEmployeeBankDetailsDescription: 'Verzamel bankgegevens van medewerkers zodat je ze in meer dan één land kunt terugbetalen.',
        businessBankAccountCountries: 'Landen met zakelijke bankrekeningen',
        reimbursementCountriesErrorMessage: 'Je update van terugbetalingslanden is mislukt. Probeer het alsjeblieft opnieuw.',
    },
