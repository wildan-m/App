...
_Voor meer gedetailleerde instructies, [bezoek onze help-site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        businessCentral: {
            importDescription: 'Kies welke coderingsconfiguraties je wilt importeren uit Business Central.',
            accountsDescription: 'Je Business Central-rekeningschema wordt als categorieën geïmporteerd.',
            enableNewAccountsTitle: 'Nieuw geïmporteerde rekeningen inschakelen',
            enableNewAccountsDescription: 'Nieuwe Business Central-accounts zullen beschikbaar zijn als categorieën.',
            dimensionsImport: 'Business Central-dimensies importeren als tags',
            importedAsTags: 'Geïmporteerd als tags',
            notImported: 'Niet geïmporteerd',
            taxRatesDescription: 'EU-btw-tarieven importeren uit Business Central.',
        },
        dualEntry: {
