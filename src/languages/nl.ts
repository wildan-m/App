...
${amount} voor ${merchant} - ${date}`,
    ...
    statusPage: {
        ...
        chooseDelegate: 'Vervanger kiezen',
        vacationDelegateClearAfter: 'Wissen na (aanbevolen)',
        vacationDelegateWillClearOn: (date: string) => `De vervangende fiatteur wordt gewist op ${date}`,
        vacationDelegateUntil: (date: string) => `Tot ${date}`,
