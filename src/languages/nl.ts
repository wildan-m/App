...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverridesDescription: 'Een schakelaar wint altijd van de backend-status voor die beta. Onaangeroerde beta’s volgen je account.',
            resetAllBetaOverrides: 'Alle overrides resetten',
