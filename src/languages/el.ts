...
${amount} για ${merchant} - ${date}`,
    ...
    statusPage: {
        ...
        chooseDelegate: 'Επιλογή αναπληρωτή',
        vacationDelegateClearAfter: 'Εκκαθάριση μετά από (συνιστάται)',
        vacationDelegateWillClearOn: (date: string) => `Ο αναπληρωτής αδειών θα καταργηθεί στις ${date}`,
        vacationDelegateUntil: (date: string) => `Έως ${date}`,
