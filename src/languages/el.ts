...
_Για πιο αναλυτικές οδηγίες, [επισκεφθείτε τον ιστότοπο βοήθειάς μας](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        businessCentral: {
            importDescription: 'Επιλέξτε ποιες ρυθμίσεις κωδικοποίησης θα εισαχθούν από το Business Central.',
            accountsDescription: 'Το λογιστικό σχέδιο του Business Central θα εισαχθεί ως κατηγορίες.',
            enableNewAccountsTitle: 'Ενεργοποίηση νέων εισαγόμενων λογαριασμών',
            enableNewAccountsDescription: 'Οι νέοι λογαριασμοί Business Central θα είναι διαθέσιμοι ως κατηγορίες.',
            dimensionsImport: 'Εισαγωγή διαστάσεων Business Central ως ετικέτες',
            importedAsTags: 'Εισάγεται ως ετικέτες',
            notImported: 'Δεν εισάγεται',
            taxRatesDescription: 'Εισαγωγή συντελεστών ΦΠΑ ΕΕ από το Business Central.',
        },
        dualEntry: {
