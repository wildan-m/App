...
3. Μόλις ενεργοποιηθεί η ροή, κάντε κλικ στην «Υποβολή» παρακάτω και θα αναλάβουμε να την προσθέσουμε.`,
            ...
            bulkEditStartDateDescription:
                'Επίλεξε ημερομηνία έναρξης συναλλαγών για όλες τις επιλεγμένες κάρτες. Θα συγχρονίσουμε τις συναλλαγές από εκείνη την ημερομηνία και μετά, εξαιρώντας όσες έχουμε ήδη εισαγάγει.',
            bulkUpdateTransactionStartDate: 'Ενημέρωση ημερομηνίας έναρξης συναλλαγών',
            bulkStartDateUpdated: 'Η ημερομηνία έναρξης συναλλαγών ενημερώθηκε',
            bulkStartDateUpdatedDescription: 'Η ημερομηνία έναρξης συναλλαγών ενημερώθηκε για όλες τις επιλεγμένες κάρτες.',
