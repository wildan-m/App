...
Ορίστε μία *δοκιμαστική απόδειξη* για να σας δείξω πώς λειτουργεί:`,
    ...
    productMarketingWindow: {
        august2026: {
            cta: 'Δοκιμάστε το',
            admin: {heading: 'Βελτιωμένη αντιστοίχιση προμηθευτών', body: 'Δημιουργήστε προμηθευτές και προσαρμοσμένους κανόνες για εύκολη αντιστοίχιση με τα κύρια λογιστικά πακέτα.'},
            member: {
                heading: 'Έτοιμοι πράκτορες για εσάς',
                body: 'Χρησιμοποιήστε προκατασκευασμένους ή προσαρμοσμένους agents για να καταχωρίζετε, να διαχωρίζετε και να υποβάλλετε αυτόματα τις δαπάνες εκ μέρους σας.',
            },
        },
    },
