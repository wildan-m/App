...
(π.χ. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverridesDescription: 'Ένας διακόπτης υπερισχύει πάντα της κατάστασης του backend για αυτό το beta. Τα ανέγγιχτα beta ακολουθούν τον λογαριασμό σας.',
            resetAllBetaOverrides: 'Επαναφορά όλων των παρακάμψεων',
            overridden: 'παρακαμφθηκε',
