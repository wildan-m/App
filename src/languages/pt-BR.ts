...
${amount} para ${merchant} - ${date}`,
        ...
        visitAnATM: 'Altere seu PIN em qualquer caixa eletrônico',
        visitAnATMDescription: 'Isso é obrigatório na sua região. <concierge-link>Falar com a Concierge</concierge-link> se você tiver alguma dúvida.',
