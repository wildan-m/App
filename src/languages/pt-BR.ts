...
(p.ex., ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverridesDescription: 'Um interruptor sempre prevalece sobre o estado do backend para essa beta. Betas não alteradas seguem sua conta.',
            resetAllBetaOverrides: 'Redefinir todos os overrides',
