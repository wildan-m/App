...
_Para instruções mais detalhadas, [visite nossa central de ajuda](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        businessCentral: {
            importDescription: 'Escolha quais configurações de codificação importar do Business Central.',
            accountsDescription: 'Seu plano de contas do Business Central será importado como categorias.',
            enableNewAccountsTitle: 'Ativar contas recém-importadas',
            enableNewAccountsDescription: 'Novas contas do Business Central estarão disponíveis como categorias.',
            dimensionsImport: 'Importar dimensões do Business Central como tags',
            importedAsTags: 'Importada como tags',
            notImported: 'Não importada',
            taxRatesDescription: 'Importe as alíquotas de IVA da UE do Business Central.',
        },
        dualEntry: {
