...
${amount} para ${merchant} - ${date}`,
    ...
    addPersonalBankAccount: {
        ...
        internationalBankAccountDetailsStepHeader: 'Quais são os dados da sua conta bancária internacional?',
        internationalBankAccountDetailsStepSubHeader: 'Precisamos desses dados para que o administrador do seu workspace possa enviar pagamentos para o seu banco em outros países.',
        iban: 'IBAN',
        swiftCode: 'Código SWIFT/BIC',
        error: {invalidSwiftCodeOrIban: 'Insira um código Swift/IBAN válido'},
    },
