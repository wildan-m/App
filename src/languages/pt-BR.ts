...
${amount} para ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        manager: 'Gerente',
        collectEmployeeBankDetails: 'Coletar dados bancários de funcionários',
        collectEmployeeBankDetailsDescription: 'Colete dados bancários dos funcionários para poder reembolsá-los em mais de um país.',
        businessBankAccountCountries: 'Países de contas bancárias empresariais',
        reimbursementCountriesErrorMessage: 'A atualização dos seus países de reembolso falhou. Tente novamente.',
    },
