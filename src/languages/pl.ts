...
${amount} dla ${merchant} - ${date}`,
    ...
    addPersonalBankAccount: {
        ...
        internationalBankAccountDetailsStepHeader: 'Jakie są dane twojego międzynarodowego konta bankowego?',
        internationalBankAccountDetailsStepSubHeader: 'Potrzebujemy tych danych, żeby administrator twojego workspace’u mógł wysyłać płatności na twoje konto bankowe za granicę.',
        iban: 'IBAN',
        swiftCode: 'Kod SWIFT/BIC',
        error: {invalidSwiftCodeOrIban: 'Wpisz poprawny kod SWIFT/IBAN'},
    },
