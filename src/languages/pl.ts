...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverridesDescription: 'Przełącznik zawsze wygrywa ze stanem backendu dla danej bety. Nietknięte bety podążają za Twoim kontem.',
            resetAllBetaOverrides: 'Zresetuj wszystkie nadpisania',
