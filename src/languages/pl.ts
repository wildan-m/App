...
${amount} dla ${merchant} - ${date}`,
    ...
    statusPage: {
        ...
        chooseDelegate: 'Wybierz zastępcę',
        vacationDelegateClearAfter: 'Wyczyść po (zalecane)',
        vacationDelegateWillClearOn: (date: string) => `Zastępca na czas urlopu zostanie usunięty ${date}`,
        vacationDelegateUntil: (date: string) => `Do ${date}`,
