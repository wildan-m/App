...
${amount} dla ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        manager: 'Menedżer',
        collectEmployeeBankDetails: 'Zbierz dane bankowe pracowników',
        collectEmployeeBankDetailsDescription: 'Zbieraj dane bankowe od pracowników, żeby móc im zwracać koszty w więcej niż jednym kraju.',
        businessBankAccountCountries: 'Kraje firmowych kont bankowych',
        reimbursementCountriesErrorMessage: 'Aktualizacja krajów zwrotu kosztów nie powiodła się. Spróbuj ponownie.',
    },
