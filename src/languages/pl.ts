...
_Aby uzyskać bardziej szczegółowe instrukcje, [odwiedź naszą stronę pomocy](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        businessCentral: {
            importDescription: 'Wybierz, które konfiguracje kodowania zaimportować z Business Central.',
            accountsDescription: 'Twój plan kont Business Central zostanie zaimportowany jako kategorie.',
            enableNewAccountsTitle: 'Włącz nowo zaimportowane konta',
            enableNewAccountsDescription: 'Nowe konta Business Central będą dostępne jako kategorie.',
            dimensionsImport: 'Importuj wymiary Business Central jako tagi',
            importedAsTags: 'Zaimportowany jako tagi',
            notImported: 'Niezaimportowany',
            taxRatesDescription: 'Importuj stawki VAT UE z Business Central.',
        },
        dualEntry: {
