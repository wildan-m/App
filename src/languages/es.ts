...
${amount} para ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        collectEmployeeBankDetails: 'Recopila los datos bancarios de los empleados',
        collectEmployeeBankDetailsDescription: 'Recoge los datos bancarios de los empleados para poder reembolsarles en más de un país.',
        businessBankAccountCountries: 'Países de cuentas bancarias de empresa',
        reimbursementCountriesErrorMessage: 'La actualización de tus países de reembolso ha fallado. Por favor, inténtalo de nuevo.',
    },
