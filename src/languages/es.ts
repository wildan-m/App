...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        businessCentral: {
            importDescription: 'Elige qué configuraciones de codificación importar desde Business Central.',
            accountsDescription: 'Tu plan de cuentas de Business Central se importará como categorías.',
            enableNewAccountsTitle: 'Habilitar cuentas recién importadas',
            enableNewAccountsDescription: 'Las nuevas cuentas de Business Central estarán disponibles como categorías.',
            dimensionsImport: 'Importar dimensiones de Business Central como etiquetas',
            importedAsTags: 'Importada como etiquetas',
            notImported: 'No importada',
            taxRatesDescription: 'Importa las tasas de IVA de la UE desde Business Central.',
        },
        dualEntry: {
