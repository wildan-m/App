    ...
    workspace: {
        ...
        rules: {
            individualExpenseRules: {
                ...
                publicReceiptVisibility: 'Visibilidad pública de recibos',
                publicReceiptVisibilityDisabledHint: 'Los recibos solo pueden verlos los miembros de Expensify con acceso al informe que contiene el recibo.',
                publicReceiptVisibilityEnabledHint: 'Los recibos pueden verlos cualquier persona que tenga la URL. No es necesario tener acceso al informe que contiene el recibo.',
