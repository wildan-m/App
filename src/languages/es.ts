    ...
    workspace: {
        ...
        rules: {
            ...
            spendRules: {
                ...
                noCardsIssuedTitle: 'Aún no se han emitido tarjetas Expensify',
                noCardsIssuedSubtitle: 'Emite tarjetas Expensify en tu espacio de trabajo antes de crear reglas de gasto.',
                saveRule: 'Guardar regla',
                deleteRule: 'Eliminar regla',
                deleteRuleConfirmation: '¿Estás seguro de que quieres eliminar esta regla?',
                allow: 'Permitir',
