...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        hr: {
            ...
            syncingEmployees: 'Sincronizando empleados',
            firstSync: {
                title: 'Tu conexión se está sincronizando',
                prompt: 'La primera conexión puede tardar un poco. Se te notificará de cualquier error.',
            },
