...
const translations: TranslationDeepObject<typeof en> = {
    ...
    concierge: {
        ...
        feedback: {prompt: '¿Te ha resultado útil esta respuesta?', thanks: '¡Gracias por tus comentarios!', useful: 'Esta respuesta fue útil', notUseful: 'Esta respuesta no fue útil'},
    },
    supportalNoAccess: {
        title: 'No tan rápido',
