    ...
    workspace: {
        ...
        rules: {
            ...
            companyRulesPdf: {
                ...
                uploadDescription: 'Arrastra y suelta un PDF con las reglas de tu empresa',
                uploadFallback: 'o haz clic para elegir un archivo',
                replace: 'Reemplazar',
                remove: 'Eliminar',
                notPdf: 'Solo se permiten archivos PDF',
            },
        },
    },
    getAssistancePage: {
