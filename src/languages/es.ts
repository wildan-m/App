...
${amount} para ${merchant} - ${date}`,
    ...
    statusPage: {
        ...
        chooseDelegate: 'Elegir delegado',
        vacationDelegateClearAfter: 'Borrar después de (recomendado)',
        vacationDelegateWillClearOn: (date: string) => `El delegado de vacaciones se borrará el ${date}`,
        vacationDelegateUntil: (date: string) => `Hasta el ${date}`,
