...
${amount} para ${merchant} - ${date}`,
    ...
    addPersonalBankAccount: {
        ...
        internationalBankAccountDetailsStepHeader: '¿Cuáles son los datos de tu cuenta bancaria internacional?',
        internationalBankAccountDetailsStepSubHeader: 'Necesitamos estos datos para que el administrador de tu espacio de trabajo pueda enviar pagos a tu banco a través de fronteras.',
        iban: 'IBAN',
        swiftCode: 'Código SWIFT/BIC',
        error: {invalidSwiftCodeOrIban: 'Por favor, introduce un código Swift/IBAN válido'},
    },
