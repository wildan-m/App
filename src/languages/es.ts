...
${amount} para ${merchant} - ${date}`,
        ...
        visitAnATM: 'Cambia tu PIN en cualquier cajero automático',
        visitAnATMDescription: 'Esto es obligatorio en tu región. <concierge-link>Contacta a Concierge</concierge-link> si tienes alguna pregunta.',
