...
const translations: TranslationDeepObject<typeof en> = {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverrides: 'Overrides de betas',
            betaOverridesDescription: 'Un interruptor siempre prevalece sobre el estado del backend para esa beta. Las betas sin tocar siguen tu cuenta.',
            resetAllBetaOverrides: 'Restablecer todos los overrides',
