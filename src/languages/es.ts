    ...
    workspace: {
        ...
        hr: {
            ...
            gusto: {
                ...
                syncError: ({message}) => `Error de sincronización: ${message}`,
                disconnectPrompt: '¿Quieres desconectar Gusto de este espacio de trabajo? Puedes volver a conectarlo más tarde.',
                approvalMode: 'Modo de aprobación',
                approvalModeDescription: 'Elige cómo se deben crear las cadenas de aprobación de Gusto en este espacio de trabajo.',
                approvalModeWarningTitle: 'Guardar modo de aprobación',
                approvalModeWarningPrompt: 'Cambiar el modo de aprobación volverá a crear las cadenas de aprobación de Gusto en la próxima sincronización.',
                ...
                approvalModeDescriptions: {
                    basic: 'Usa una cadena de aprobación básica.',
                    manager: 'Envía las aprobaciones al gerente de cada empleado.',
                    custom: 'Usa el aprobador final personalizado para las aprobaciones.',
                },
            },
        },
        export: {
