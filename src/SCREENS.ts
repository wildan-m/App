...
const SCREENS = {
    ...
    WORKSPACE: {
        ...
        COMPANY_CARDS_BULK_TRANSACTION_START_DATE: 'Workspace_CompanyCards_Bulk_Transaction_Start_Date',
        COMPANY_CARDS_BULK_TRANSACTION_START_DATE_SUCCESS: 'Workspace_CompanyCards_Bulk_Transaction_Start_Date_Success',
