...
import {buildSearchQueryJSON, buildSearchQueryString, getFilterFromQuery, getViolationHasFilterValues, isDefaultExpensesQuery, serializeQueryJSONForBackend} from '@libs/SearchQueryUtils';
    ...
    const getCSVExportParameters = useCallback(
        (isBasicExport: boolean, queryJSONToExport: SearchQueryJSON | undefined, exactMatchFilterKeys?: ReadonlySet<SearchFilterKey>) => {
            ...
            if (groupBy) {
                ...
                if (getViolationHasFilterValues(queryJSON)) {
                ...
                columnsToExport = getColumnsToShow({
                    ...
                    violationHasFilterValues: getViolationHasFilterValues(queryJSON),
                });
            }
