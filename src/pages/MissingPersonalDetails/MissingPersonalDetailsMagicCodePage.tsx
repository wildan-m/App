...
function MissingPersonalDetailsMagicCodePage({
    ...
    return (
        <ValidateCodeActionContent
            ...
            sendValidateCode={() => requestValidateCodeAction(isVirtualCard ? {reasonCode: COMMON_CONST.VALIDATE_CODE_REASONS.REVEAL_CARD_DETAILS, reasonCardID: Number(cardID)} : undefined)}
