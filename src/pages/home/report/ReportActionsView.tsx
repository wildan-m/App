...
function ReportActionsView({
    ...
    const combinedReportActions = useMemo(
        () => ReportActionsUtils.getSortedReportActions(ReportActionsUtils.getCombinedReportActions(reportActionsToDisplay, transactionThreadReportID ?? null, transactionThreadReportActions), true, true),
