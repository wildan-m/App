...
function ReportActionItemMessageEdit(props) {
    ...
    const deleteDraft = useCallback(() => {
        console.log(`[debug] deleteDraft ${textInputRef.current.value}`)
    ...
    const publishDraft = useCallback(() => {
        ...
        console.log('[debug] if (ReportUtils.getCommentLength(draft) > CONST.MAX_COMMENT_LENGTH) {')
        ...
        console.log('[debug] if (lodashGet(props.drafts, [`${ONYXKEYS.COLLECTION.REPORT_ACTIONS_D')
        ...
        console.log('[debug]  if (props.action.childReportID) {')
        ...
        console.log('[debug] if (!trimmedNewDraft) {')
            ...
            ReportActionContextMenu.showDeleteModal(props.reportID, props.action, false, deleteDraft, restoreFocus);
            return;
        }
                ...
                >
                    ...
                    <View style={styles.editChatItemEmojiWrapper}>
                        <EmojiPickerButton
                            ...
                            onModalHide={() => restoreFocus(false)}
