            ...
            >
                <View style={[styles.ph5, styles.mb4, styles.mt3]}>
                    <TwoFactorAuthForm
                        ...
                        authAppExplanation={translate('twoFactorAuth.verifyOldDeviceDescription')}
                        recoveryCodeExplanation={translate('twoFactorAuth.verifyOldDeviceWithRecoveryDescription')}
                        onSubmit={(code) => {
