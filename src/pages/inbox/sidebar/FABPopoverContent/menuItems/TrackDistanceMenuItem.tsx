...
function TrackDistanceMenuItem({reportID}: TrackDistanceMenuItemProps) {
    ...
    return (
        <FABFocusableMenuItem
            ...
            onPress={() => interceptAnonymousUser(() => startDistanceRequest(CONST.IOU.TYPE.CREATE, reportID, draftTransactionIDs, lastDistanceExpenseType, undefined, undefined, true))}
