...
import type {ConnectPolicyToAccountingIntegrationParams, ConnectPolicyToNetSuiteParams} from '@libs/API/parameters';
...
function getNetSuiteOAuthSetupLink(policyID: string) {
    const params: ConnectPolicyToAccountingIntegrationParams = {policyID};
    const commandURL = getCommandURL({
        command: READ_COMMANDS.CONNECT_POLICY_TO_NETSUITE_OAUTH,
