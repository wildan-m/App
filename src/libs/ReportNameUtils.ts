...
function computeReportNameBasedOnReportAction(
    ...
    if (isActionOfType(parentReportAction, CONST.REPORT.ACTIONS.TYPE.RECEIPT_SCAN_FAILED)) {
        ...
        return translate('violations.smartscanFailed', {canEdit: wasActionTakenByCurrentUser(iouAction), missingFields: getOriginalMessage(parentReportAction)?.missingFields ?? []});
    }
