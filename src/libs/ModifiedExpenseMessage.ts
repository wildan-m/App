...
function buildMessageFragmentForValue(
    ...
    const isOldCategoryMissing = isCategoryField && isCategoryMissing(oldValue, policyCategories);
    const isNewCategoryMissing = isCategoryField && isCategoryMissing(newValue, policyCategories);
