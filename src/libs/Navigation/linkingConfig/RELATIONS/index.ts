...
// Deeplink-only variant of RHP_TO_SETTINGS. Consulted only when building state from a path
...
// Deeplink-only variant of RHP_TO_HOME. Consulted only when building state from a path
// (see the `isDeeplink` flag in getMatchingFullScreenRoute), never for in-app navigation.
