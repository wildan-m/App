...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.COMPANY_CARDS_BULK_TRANSACTION_START_DATE]: () =>
        require<ReactComponentModule>('../../../../pages/workspace/companyCards/WorkspaceCompanyCardsBulkTransactionStartDatePage').default,
    [SCREENS.WORKSPACE.COMPANY_CARDS_BULK_TRANSACTION_START_DATE_SUCCESS]: () =>
        require<ReactComponentModule>('../../../../pages/workspace/companyCards/WorkspaceCompanyCardsBulkTransactionStartDateSuccessPage').default,
