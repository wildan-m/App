...
type DismissedProductTraining = {
    ...
    /**
     * When user dismisses the Agents promotion banner on Workspace > Workflows, we store the timestamp here.
     */
    [CONST.AGENTS_WORKFLOWS_BANNER]: DismissedProductTrainingElement;

    /**
     * When user dismisses the Agents promotion banner on Workspace > Rules, we store the timestamp here.
     */
