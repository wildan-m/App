...
function MoneyRequestView({
    ...
    const isMarkAsCash =
        parentReport && currentUserEmailParam
            ? isMarkAsCashActionForTransaction(currentUserEmailParam, parentReport, updatedTransaction ?? transaction, transactionViolations, policy)
            : false;
