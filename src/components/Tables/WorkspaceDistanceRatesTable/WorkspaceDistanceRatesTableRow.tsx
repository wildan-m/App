...
function WorkspaceDistanceRatesTableRow({item, rowIndex, shouldUseNarrowTableLayout, shouldShowDateColumns, statusLabels}: WorkspaceDistanceRatesTableRowProps) {
    ...
    const isAutoGenerated = isGovernmentRateUnmodified(rate);

    const autoGeneratedIcon = isAutoGenerated ? (
        <Tooltip text={translate('workspace.distanceRates.autoGeneratedRate')}>
            <View>
                <Icon
