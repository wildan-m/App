...
type LabelLayoutConfig = {
    ...
    /** When true, a failed 45° fit requests horizontal-bar mode instead of the 90° + label-skipping fallback. */
...
function useChartLabelLayout({
    ...
    // Pick rotation (prefer 0° → 45° → 90°, or horizontal bars instead of 90° when preferHorizontalBars is set)
