...
type ConfirmContentProps = {
    ...
    /** The visual variant of the confirm button. Use danger if the action is destructive. Defaults to success */
...
function ConfirmContent({
    ...
    // The success variant is only honored when a cancel button is rendered alongside the confirm button
    // (or when explicitly forced) — single-button modals downgrade to a plain confirm button.
    ...
    } else if (variant === CONST.BUTTON_VARIANT.SUCCESS && (shouldUseSuccessStyleForConfirm || shouldShowCancelButton)) {
