...
import {getFieldRequiredErrors, isValidAddress, isValidCardName, isValidDebitCard, isValidExpirationDate, isValidPaymentZipCode, isValidSecurityCode} from '@libs/ValidationUtils';
...
function PaymentCardForm({
    ...
    const validate = (values: FormOnyxValues<typeof ONYXKEYS.FORMS.ADD_PAYMENT_CARD_FORM>): FormInputErrors<typeof ONYXKEYS.FORMS.ADD_PAYMENT_CARD_FORM> => {
        ...
        if (values.nameOnCard && !isValidCardName(values.nameOnCard)) {
