...
function MenuItemIcon({src}: MenuItemIconProps) {
    ...
    const isPane = true;
    const iconFill = StyleUtils.getIconFillColor({buttonState: getButtonState({isActive: isHovered, isPressed, isComplete, isDisabled, isInteractive}), isMenuIcon, isPane});
