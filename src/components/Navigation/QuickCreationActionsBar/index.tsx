...
function QuickCreationActionsBar() {
    ...
    const handleExpense = useCallback(() => interceptAnonymousUser(() => startMoneyRequest(CONST.IOU.TYPE.CREATE, generateReportID(), draftTransactionIDs)), [draftTransactionIDs]);
    ...
    const handleDistance = useCallback(
        () => interceptAnonymousUser(() => startDistanceRequest(CONST.IOU.TYPE.CREATE, generateReportID(), draftTransactionIDs, lastDistanceExpenseType)),
